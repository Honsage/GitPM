...
public class EditProjectDialogController {
    ...
    public void setProjectInfo(ProjectViewModel project) {
        titleField.setText(project.getTitle());
        descriptionField.setText(project.getDescription());
        localPathField.setText(project.getLocalPath());
        if (project.getRemoteURL() != null)
            remoteUrlField.setText(project.getRemoteURL());
    }
